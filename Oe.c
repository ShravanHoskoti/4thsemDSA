...
struct node // Creating a Structure named node
{
  int data;
  struct node *lc;
  struct node *rc;
...
struct stack
{ // Creating a Structure named stack
...
void push(struct stack *s, NODE p) // Push Function
{
  if (s->top == STACKSIZE)
  {
    printf("STACK FULL!!!!!!!!");
...
NODE pop(struct stack *s) // Pop Function
{
  NODE p;
  if (s->top == -1)
  {
